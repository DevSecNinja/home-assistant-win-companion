...
- [x] T003 Implement UpdatePackageDownloader with progress, single-flight, and cancellation-safe streaming.
...
- [x] T006 Add UpdateInstaller orchestrator in Core coordinating download, verify, and install transitions.
