...
2. Automatic refresh updates only the current-value text; it does not recreate rows, alter toggles, change search text, or initiate Home Assistant synchronization.
