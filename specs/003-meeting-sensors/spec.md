...
- **SC-001**: Median microphone and camera detection latency is at most 1 second
  after Windows updates its capability history, and median Home Assistant state
  latency is at most 2 seconds; other meeting sensor changes appear within 15 seconds.
